...
layout(binding = 1) readonly buffer FilterBuf { float data[]; } filterBuf;
layout(binding = 2) writeonly buffer OutputBuf { float data[]; } outputBuf;
layout(binding = 3) readonly buffer InputBufH { float16_t data[]; } inputBufH;
layout(binding = 4) writeonly buffer OutBufH { float16_t data[]; } outBufH;
layout(binding = 5) readonly buffer FilterBufH { float16_t data[]; } filterBufH;
