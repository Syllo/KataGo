...
layout(binding = 2) readonly buffer ScaleBuf { float data[]; } scaleBuf;
layout(binding = 3) readonly buffer BiasBuf { float data[]; } biasBuf;
...
layout(binding = 5) readonly buffer DynamicBiasBuf { float data[]; } dynamicBiasBuf;
layout(binding = 5) readonly buffer DynamicBiasBufV4 { vec4 data[]; } dynamicBiasBufV4;

layout(binding = 6) readonly buffer InputBufH { float16_t data[]; } inputBufH;
layout(binding = 7) writeonly buffer OutputBufH { float16_t data[]; } outputBufH;
layout(binding = 8) readonly buffer ScaleBufH { float16_t data[]; } scaleBufH;
layout(binding = 9) readonly buffer BiasBufH { float16_t data[]; } biasBufH;
layout(binding = 10) readonly buffer MaskBufH { float16_t data[]; } maskBufH;
...
layout(binding = 11) readonly buffer InputBufV4 { vec4 data[]; } inputBufV4;
layout(binding = 12) writeonly buffer OutputBufV4 { vec4 data[]; } outputBufV4;
layout(binding = 13) readonly buffer ScaleBufV4 { vec4 data[]; } scaleBufV4;
layout(binding = 14) readonly buffer BiasBufV4 { vec4 data[]; } biasBufV4;
layout(binding = 15) readonly buffer InputBufV4H { f16vec4 data[]; } inputBufV4H;
layout(binding = 16) writeonly buffer OutputBufV4H { f16vec4 data[]; } outputBufV4H;
layout(binding = 17) readonly buffer ScaleBufV4H { f16vec4 data[]; } scaleBufV4H;
layout(binding = 18) readonly buffer BiasBufV4H { f16vec4 data[]; } biasBufV4H;
