...
layout(binding = 0) buffer TensorBuf { float data[]; } tensorBuf;
layout(binding = 1) readonly buffer ScaleBuf { float data[]; } scaleBuf;
layout(binding = 2) readonly buffer BiasBuf { float data[]; } biasBuf;
layout(binding = 3) readonly buffer MaskBuf { float data[]; } maskBuf;
...
layout(binding = 4) readonly buffer DynamicBiasBuf { float data[]; } dynamicBiasBuf;
layout(binding = 4) readonly buffer DynamicBiasBufV4 { vec4 data[]; } dynamicBiasBufV4;

layout(binding = 5) buffer TensorBufH { float16_t data[]; } tensorBufH;
layout(binding = 6) readonly buffer ScaleBufH { float16_t data[]; } scaleBufH;
layout(binding = 7) readonly buffer BiasBufH { float16_t data[]; } biasBufH;
layout(binding = 8) readonly buffer MaskBufH { float16_t data[]; } maskBufH;
...
layout(binding = 9) buffer TensorBufV4 { vec4 data[]; } tensorBufV4;
layout(binding = 10) readonly buffer ScaleBufV4 { vec4 data[]; } scaleBufV4;
layout(binding = 11) readonly buffer BiasBufV4 { vec4 data[]; } biasBufV4;
layout(binding = 12) buffer TensorBufV4H { f16vec4 data[]; } tensorBufV4H;
layout(binding = 13) readonly buffer ScaleBufV4H { f16vec4 data[]; } scaleBufV4H;
layout(binding = 14) readonly buffer BiasBufV4H { f16vec4 data[]; } biasBufV4H;
