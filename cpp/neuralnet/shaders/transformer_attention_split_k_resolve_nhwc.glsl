...
layout(binding = 0) readonly buffer PartialsBuf { float data[]; } partialsBuf;
layout(binding = 1) readonly buffer StatsBuf { float data[]; } statsBuf;
layout(binding = 2) writeonly buffer OutBuf { uint data[]; } outBuf;
